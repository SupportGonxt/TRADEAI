...
import RetailerCollaborationPortal from './pages/retailer-collaboration/RetailerCollaborationPortal';
  ...
  return (
    <ErrorBoundary>
      <ToastProvider>
        ...
        />
        <Route 
          path="/retailer-collaboration"
          element={
            isAuthenticated ? (
              <Layout user={user} onLogout={handleLogout}>
                <RetailerCollaborationPortal />
              </Layout>
            ) : (
              <Navigate to="/" replace />
            )
        ...
        />
        <Route 
          path="/retailer-collaboration/:id"
          element={
            isAuthenticated ? (
              <Layout user={user} onLogout={handleLogout}>
                <RetailerCollaborationPortal />
